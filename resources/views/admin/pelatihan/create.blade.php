                  ...
                  <form action="{{route('pelatihan.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" name="tanggal_selesai" id="tanggal_selesai" value="{{old('tanggal_selesai')}}" required>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control @error('kuota_tim') is-invalid @enderror" name="kuota_tim" id="kuota_tim" value="{{old('kuota_tim')}}" required>
                        @error('kuota_tim')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
