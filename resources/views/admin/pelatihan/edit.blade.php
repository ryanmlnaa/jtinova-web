                        ...
                        <form action="{{ route('pelatihan.update', $pelatihan) }}" method="post"
                                    ...
                                    <select class="form-control @error('id_kategori') is-invalid @enderror"
                                        ...
                                        @foreach ($kategori as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('id_kategori', $pelatihan->id_kategori) == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_kategori')
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                        name="kode" id="kode" value="{{ old('kode', $pelatihan->kode) }}" required>
                                    @error('kode')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label for="deskripsi" class="col-form-label">Deskripsi</label> <span
                                        class="text-danger">*</span>
                                    <textarea type="number" class="summernote-simple @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                        id="deskripsi" required>{{ old('deskripsi', $pelatihan->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_selesai', $pelatihan->tanggal_selesai) }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror"
                                        name="lokasi" id="lokasi" value="{{ old('lokasi', $pelatihan->lokasi) }}"
                                        required>
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" name="status"
                                        ...
                                        <option value="Aktif"
                                            {{ old('status', $pelatihan->status) == 'Aktif' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="Tidak Aktif"
                                            {{ old('status', $pelatihan->status) == 'Tidak Aktif' ? 'selected' : '' }}>
                                            Tidak Aktif</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control @error('kuota_tim') is-invalid @enderror"
                                        name="kuota_tim" id="kuota_tim"
                                        value="{{ old('kuota_tim', $pelatihan->kuota_tim) }}" required>
                                    @error('kuota_tim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                <label for="foto" class="col-form-label">Gambar</label> <span
                                    class="text-danger">*</span>
                                <img src="{{ asset('storage/' . $pelatihan->foto) }}" alt="foto"
                            ...
                            <div class="form-group">
                                <label for="syllabus_link" class="col-form-label">Silabus</label> <span
                                    class="text-danger">* (Format PDF) <a
                                        href="{{ asset('storage/' . $pelatihan->syllabus_link) }}" target="_blank">Lihat
                                        Silabus</a></span>
