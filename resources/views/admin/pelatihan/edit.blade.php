                  ...
                  <form action="{{route('pelatihan.update', $pelatihan)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" value="{{old('nama', $pelatihan->nama)}}" required>
                        @error('nama')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="{{old('kode', $pelatihan->kode)}}" required>
                        @error('kode')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" value="{{old('harga', $pelatihan->harga)}}" required>
                        @error('harga')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <textarea type="number" class="summernote-simple @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" required>{{old('deskripsi', $pelatihan->deskripsi)}}</textarea>
                        @error('deskripsi')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                      ...
                      <div class="form-group col-6">
                        ...
                        <textarea class="summernote-simple @error('benefit') is-invalid @enderror" name="benefit" id="benefit" required>{{old('benefit', $pelatihan->benefit)}}</textarea>
                        @error('benefit')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror" name="tanggal_mulai" id="tanggal_mulai" value="{{old('tanggal_mulai', $pelatihan->tanggal_mulai)}}" required>
                        @error('tanggal_mulai')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" name="tanggal_selesai" id="tanggal_selesai" value="{{old('tanggal_selesai', $pelatihan->tanggal_selesai)}}" required>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" id="lokasi" value="{{old('lokasi', $pelatihan->lokasi)}}" required>
                        @error('lokasi')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control @error('kuota_tim') is-invalid @enderror" name="kuota_tim" id="kuota_tim" value="{{old('kuota_tim', $pelatihan->kuota_tim)}}" required>
                        @error('kuota_tim')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control @error('kuota') is-invalid @enderror" name="kuota" id="kuota" value="{{old('kuota', $pelatihan->kuota)}}" required>
                        @error('kuota')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
