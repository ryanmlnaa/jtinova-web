                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-md">
                            ...
                            <tr>
                                ...
                                <td>{{ $item->alamat }}</td>
                                <td>
                                    <img src="{{ url('foto_ktp_peserta/' . $item->foto_ktp) }}"
                                ...
                                <td>
                                    <form action="/hapuspeserta/{{ $item->id_peserta }}" method="post"
                                        class="delete-form">
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function(event) {
                ...
                const id = this.parentNode.querySelector('input[name="id_peserta"]').value;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.parentNode.action = '/hapuspeserta/' + id;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{Route('Peserta.tambah')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nip" class="col-form-label">Nama Peserta<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nama_peserta" id="nip">
                    </div>
                    <div class="form-group">
