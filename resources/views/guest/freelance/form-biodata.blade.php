...
@section('title', $title)
@php
$timeline = \App\Models\Timeline::where('status', 1)->where('jenis', 'freelance')->first();
if ($timeline) {
    ...
    <div class="row">
        <div
            ...
            <div class="alert alert-light">
                <h4 class="alert-heading">Pendaftaran Freelance</h4>
            ...
            <div class="alert alert-light">
                <h4 class="alert-heading">Pendaftaran Freelance</h4>
                <p><span class="text-info">Mohon maaf</span>, anda <span class="text-info">tidak lolos</span> seleksi Freelance. Silahkan coba lagi di periode berikutnya.</p>
            </div>
            <div class="form-group text-center">
                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg">
                    Kembali ke Dashboard
            ...
            <div class="alert alert-light">
                <h4 class="alert-heading">Pendaftaran Freelance</h4>
                <p>Selamat, anda <span class="text-success">lolos</span> seleksi Freelance. Silahkan cek email dan dashboard untuk informasi lebih lanjut.</p>
            </div>
            <div class="form-group text-center">
                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg">
                    Kembali ke Dashboard
            ...
            <div class="alert alert-light">
                <h4 class="alert-heading">Pendaftaran Freelance</h4>
                <p>Pendaftaran Freelance belum dibuka atau sudah ditutup. Pantau terus informasi di website ini atau di email anda.</p>
            </div>
            <div class="form-group text-center">
                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg">
                    Kembali ke Dashboard
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Daftar Freelance</h4>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('freelance.freelanceuser.store') }}" enctype="multipart/form-data">
                        @csrf
                        @if(!Auth::check())
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="cv">Upload CV Terbaru</label> <span class="text-danger">*</span>
                            ...
                            <div class="form-group col-6">
                                <label for="foto">Upload Foto Terbaru</label> <span class="text-danger">*</span>
