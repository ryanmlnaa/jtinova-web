...
<div class="section-header">
    <h1>Pendaftaran sedang diproses, pantau terus email dan dashboard untuk informasi lebih lanjut.</h1>
</div>
@elseif ($data && $data->status_pendaftaran == 'gagal')
<div class="section-header">
    <h1><span class="text-info">Mohon maaf</span>, anda <span class="text-info">tidak lolos</span> seleksi MBKM. Silahkan coba lagi di periode berikutnya.</h1>
</div>
@elseif ($data && $data->status_pendaftaran == 'lolos')
<div class="section-header">
    <h1>Selamat, anda <span class="text-success">lolos</span> seleksi MBKM. Silahkan cek email dan dashboard untuk informasi lebih lanjut.</h1>
</div>
@elseif ($disabled)
<div class="section-header">
    <h1>Pendaftaran sudah ditutup atau belum dibuka</h1>
</div>
@else
<div class="section-header">
