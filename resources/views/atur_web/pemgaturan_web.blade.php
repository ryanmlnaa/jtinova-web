...
@section('content')
            ...
            <div class="card">
                <div class="form-group">
                    ...
                    @if (isset($data['brand_logo']) && $data['brand_logo'] !== null)
                        <img src="{{ url('brand_logo/' . $data['brand_logo']) }}" alt=""
                            class="img-fluid bg-dark mt-2">
                    @else
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <button type="submit" class="btn btn-primary float-right"><i class="icofont-save"></i> <span
                        id="text-save">Simpan Setting</span></button>
            </div>
        </div>
