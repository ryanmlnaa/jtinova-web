    ...
    <section id="layanan" class="services section">
        ...
        @if (!$timeline)
            <div class="container section-title" data-aos="fade-up">
                <h2>Timeline Pendaftaran Freelance</h2>
                <p>Belum ada timeline pendaftaran Freelance</p>
            </div>
        @else
            <!-- Section Title -->
            <div class="container section-title" data-aos="fade-up">
                ...
                @if ($timeline->syllabus_link)
                    <h2>Silabus</h2>
                    <embed src="{{ asset('storage/' . $timeline->syllabus_link) }}" type="application/pdf" width="100%"
                        height="600px">
                @endif
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="service-item d-flex position-relative h-100">
                                ...
                                <div>
                                    ...
                                    <h5>{{ Carbon\Carbon::parse($item->start)->format('d F Y') }} -
                                        {{ Carbon\Carbon::parse($item->end)->format('d F Y') }}</h5>
                                </div>
                            </div>
