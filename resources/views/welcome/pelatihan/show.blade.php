                    ...
                    <div class="container">
                        ...
                        <article class="article">
                            ...
                            <div class="meta-top">
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center"><i class="bi bi-calendar-check"></i>
                                        ...
                                        {{ Carbon\Carbon::parse($training->tanggal_selesai)->format('d F Y') }} </li>
                                    <li class="d-flex align-items-center"><i class="bi bi-geo-alt"></i>
                                        {{ $training->lokasi }} </li>
                                    <li class="d-flex align-items-center"><i class="bi bi-tag"></i>
                                        {{ $training->kategori->name }} </li>
                                </ul>
                            </div><!-- End meta top -->
                            ...
                            <div class="content">
                                ...
                                <h3>Silabus</h3>
                                {{-- show silabus with embed --}}
                                <embed src="{{ asset('storage/' . $training->syllabus_link) }}" type="application/pdf"
                            ...
                            @auth
                                <form action="{{ route('pelatihan.pelatihanuser.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="skema" class="form-label">Skema</label> <span
                                            class="text-danger">*</span>
                                        <select name="skema" id="skema"
                                            class="form-select @error('skema') is-invalid @enderror" required>
                                        ...
                                        <div class="row input-copy-here form-kelompok" style="display: none;">
                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-anggota" name="nama[]"
                                                        id="nama" placeholder="Nama Anggota">
                                                </div>
                                            </div>
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                <div class="row">
                                                    <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10">
                                                        <input type="email" class="form-control form-anggota" name="email[]"
                                                            id="email" placeholder="Email Anggota">
                                                    </div>
                                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                                        <button type="button" class="btn btn-outline-primary btn-add"
                                                            data-toggle="tooltip" data-placement="top" title="Tambah Anggota"><i
                            ...
                            <div class="input-copy" style="display: none;">
                                <div class="row input-group mt-3">
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-anggota" name="nama[]"
                                                id="nama" placeholder="Nama Anggota" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                        <div class="row">
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10">
                                                <input type="email" class="form-control form-anggota" name="email[]"
                                                    id="email" placeholder="Email Anggota" required>
                                            </div>
                                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                                <button type="button" class="btn btn-outline-primary btn-remove"
                                                    data-toggle="tooltip" data-placement="top" title="Hapus Anggota"><i
